...
async fn id_parse(id_service: web::Data<IdService>, path: web::Path<String>) -> RouteResult<ApiResult<IdStruct>> {
...
async fn ids_wrapper(id_service: web::Data<IdService>, path: web::Path<u32>) -> RouteResult<ApiResult<Vec<String>>>{
